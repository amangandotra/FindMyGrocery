...
// event funtions
void on_rfid_detected(const char *uid)
{
    strncpy(g_issue_uid, uid, sizeof(g_issue_uid)-1);

    lv_async_call(go_to_enrollment_screen, NULL);
}
void go_to_enrollment_screen(void *p)
{
    lv_label_set_text(ui_Label19, "RFID detected!");

    _ui_screen_change(
        &ui_screenIssueEnrollment,
        LV_SCR_LOAD_ANIM_FADE_ON,
        150, 0,
        &ui_screenIssueEnrollment_screen_init
    );
}
